  ...
  def post(self, request, format=None):
    ...
    if serializer.is_valid():
      ...
      if queryset.exists():
        ...
        self.request.session['room_code'] = room.code #shows the room (or last room) the user is/was in, in the current session
  ...
  def post(self, request, format=None):
    ...
    if code != None:
      ...
      if len(room_results) > 0:
        room = room_results[0]
        self.request.session['room_code'] = code #shows the room (or last room) the user is/was in, in the current session
